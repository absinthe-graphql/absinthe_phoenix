defmodule Absinthe.Phoenix.Controller.Action do
  ...
  @spec execute(conn :: Plug.Conn.t, schema :: Absinthe.Schema.t, controller :: module, document :: Absinthe.Blueprint.t, Keyword.t) :: Plug.Conn.t
  ...
  @spec pipeline(schema :: Absinthe.Schema.t, controller :: module, Keyword.t) :: Absinthe.Pipeline.t
